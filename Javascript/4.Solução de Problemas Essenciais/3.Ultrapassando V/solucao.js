 ...
 * R e V (devem ser lidos tantos valores para V quantos necessários, até que seja digitado 
 * um valor maior do que R para ele). Conte quantos números inteiros devem ser  somados 
 * em sequência (considerando o R nesta soma) para que a soma ultrapasse a V o mínimo possível. 
